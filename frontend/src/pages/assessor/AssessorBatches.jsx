...
export default function AssessorBatches() {
  const [batches, setBatches] = useState([]);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    assessorService.myBatches()
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <h4 className="fw-bold mb-0"><i className="bi bi-layers me-2"></i>আমার মূল্যায়নের ব্যাচ</h4>
      ...
      {loading ? (
        ...
        <div className="card shadow-sm" style={{ borderRadius: 12, border: 'none' }}>
          <div className="card-body text-center py-5 text-secondary">
            ...
            আপনাকে কোনো ব্যাচে মূল্যায়নের জন্য নিয়োগ দেওয়া হয়নি
          </div>
        </div>
      ) : (
              ...
              <div className="card shadow-sm h-100" style={{ borderRadius: 12, border: 'none' }}>
                <div className="card-body d-flex flex-column">
                  ...
                  <div className="mt-auto d-flex gap-2 flex-wrap">
                    ...
                    <Link to={`/assessor/assessment/batch/${b.id}`} className="btn btn-sm btn-outline-warning flex-fill">
