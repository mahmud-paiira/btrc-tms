  ...
  const handlePrint = () => {
    ...
    w.document.write(`
      ...
      <div class="report-info">
        <span>মোট: ${escapeHtml(items.length)} জন</span>
      ...
      <table>
        ...
        ${items.map((t, i) => {
          return `<tr>
            ...
            <td style="text-align:center;">${t.years_of_experience ? escapeHtml(formatNumber(t.years_of_experience)) + ' বছর' : '—'}</td>
          </tr>`;
        }).join('')}
      </table>
  ...
  return (
    <div>
      <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <h4 className="fw-bold mb-0"><i className="bi bi-person-badge me-2"></i>প্রশিক্ষক তালিকা</h4>
        <div className="d-flex gap-2">
          ...
          <button className="btn btn-primary btn-sm" onClick={() => { setEditData(null); setShowForm(true); }}>
            <i className="bi bi-plus-lg me-1"></i>নতুন প্রশিক্ষক
          </button>
        </div>
      </div>
